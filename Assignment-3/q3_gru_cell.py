...
class GRUCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            b_r = tf.get_variable("b_r", initializer=tf.constant_initializer(0), shape=self.state_size)
            ...
            b_z = tf.get_variable("b_z", initializer=tf.constant_initializer(0), shape=self.state_size)
            ...
            b_o = tf.get_variable("b_o", initializer=tf.constant_initializer(0), shape=self.state_size)
